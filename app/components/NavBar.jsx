...
export default function NavBar() {
  ...
  return (
    <header className="flex flex-col shadow-xl items-center justify-between ">
      <div className="flex w-full justify-between px-3 md:px-9 md:py-6 py-3 items-center">
        ...
        <div>
          <Link href="/contactus" className="font-semibold text-white md:flex hidden items-center">
            <div >
              <GrContact className="w-full h-10 py-2 p-2  bg-amarillo" />
            </div>
            <span className="items-center bg-azul text-xs h-10 p-2 pr-4 hover:underline hover:text-amarillo  hover:decoration-amarillo hover:decoration-2">
  ...
  <div className="flex items-center space-x-4">
    ...
    <a href="https://www.instagram.com/fedamil/" target="_blank" rel="noopener noreferrer" className="text-amarillo hover:text-amarillo text-xl hover:scale-125">
      <AiFillInstagram className="w-6 h-6 hover:text-yellow-300"/>
    </a>
    <a href="https://www.tiktok.com/fedamil" target="_blank" rel="noopener noreferrer" className="text-amarillo hover:text-amarillo text-xl hover:scale-125">
      <RiTiktokFill className="w-6 h-6 hover:text-yellow-300"/>
    </a>
  </div>
</nav>
